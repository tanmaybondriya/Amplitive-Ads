...
const AssetReadinessCard = () => (
  <div className="rounded-3xl overflow-hidden">
    ...
    >
      <div
        className="absolute left-[-140px] bottom-[-180px] w-[340px] h-[340px] opacity-30 pointer-events-none"
        style={{
          background:
      ...
      />
      <div
        className="absolute left-0 bottom-0 pointer-events-none w-[70%] h-[70%] opacity-60"
        style={{
          backgroundImage: `
